...
public class TAS400OutputMainJava
{
  ...
  protected final String TEXT_99 = NL + "                    throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_139 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_154 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  ...
  protected final String TEXT_174 = NL + "                    throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
  protected final String TEXT_175 = NL + "        }" + NL + "        " + NL + "        if(updateFlag_";
  ...
  protected final String TEXT_190 = NL + "                        throw new RuntimeException(\"Execution failure, there might be an error in your SQL syntax.\");";
