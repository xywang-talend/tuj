...
public class TJasperOutputEndJava
{
  ...
  protected final String TEXT_10 = "+jrxmlName_";
  protected final String TEXT_11 = "+\".";
  protected final String TEXT_12 = "\";" + NL + "    " + NL + "    net.sf.jasperreports.engine.xml.JRXmlDigester digester_";
  protected final String TEXT_13 = " = new net.sf.jasperreports.engine.xml.JRXmlDigester();" + NL + "    net.sf.jasperreports.engine.xml.JRXmlDigesterFactory.configureDigester(digester_";
  protected final String TEXT_14 = ");" + NL + "    net.sf.jasperreports.engine.xml.JRXmlLoader xmlLoader_";
  protected final String TEXT_15 = " = new net.sf.jasperreports.engine.xml.JRXmlLoader(" + NL + "            digester_";
  protected final String TEXT_16 = ");" + NL + "    net.sf.jasperreports.engine.design.JasperDesign jasperDesign_";
  protected final String TEXT_17 = " = xmlLoader_";
  protected final String TEXT_18 = NL + "            .loadXML(new java.io.FileInputStream(";
  protected final String TEXT_19 = "));" + NL + "    net.sf.jasperreports.engine.JasperCompileManager.compileReportToFile(jasperDesign_";
  protected final String TEXT_20 = ", jasperFile_";
  protected final String TEXT_21 = ");" + NL + "" + NL + "    java.util.Map<String, Object> hm_";
  protected final String TEXT_22 = " = new java.util.HashMap<String, Object>();" + NL + "    hm_";
  protected final String TEXT_23 = ".put(net.sf.jasperreports.engine.JRParameter.REPORT_LOCALE, java.util.Locale.SIMPLIFIED_CHINESE);" + NL + "" + NL + "    net.sf.jasperreports.engine.data.JRCsvDataSource ds_";
  protected final String TEXT_24 = " = new net.sf.jasperreports.engine.data.JRCsvDataSource(" + NL + "            new java.io.File(tempFile_";
  protected final String TEXT_25 = "));" + NL + "" + NL + "    ds_";
  protected final String TEXT_26 = ".setFieldDelimiter(',');" + NL + "    ds_";
  protected final String TEXT_27 = ".setRecordDelimiter(\"\\n\");" + NL + "    ds_";
  ...
  protected final String TEXT_43 = ".setParameter(net.sf.jasperreports.engine.export.JRTextExporterParameter.PAGE_WIDTH, 255);" + NL + "    exporter_";
  protected final String TEXT_44 = ".setParameter(net.sf.jasperreports.engine.export.JRTextExporterParameter.CHARACTER_WIDTH, 10);" + NL + "    exporter_";
  protected final String TEXT_45 = ".setParameter(net.sf.jasperreports.engine.export.JRTextExporterParameter.PAGE_HEIGHT, 61);" + NL + "    exporter_";
  protected final String TEXT_46 = ".setParameter(net.sf.jasperreports.engine.export.JRTextExporterParameter.CHARACTER_HEIGHT, 20);        ";
