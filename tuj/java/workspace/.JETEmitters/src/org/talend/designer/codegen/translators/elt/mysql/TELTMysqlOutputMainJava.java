package org.talend.designer.codegen.translators.elt.mysql;
...
public class TELTMysqlOutputMainJava
{
  ...
  protected final String TEXT_6 = NL + "java.lang.Class.forName(\"org.gjt.mm.mysql.Driver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_7 = " = \"jdbc:mysql://\"+";
  ...
  protected final String TEXT_33 = NL + "+\"  WHERE \" + CodeGenerationUtils.replaceAllCrBySpace(";
  protected final String TEXT_34 = ")";
  protected final String TEXT_35 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_36 = " = conn_";
  protected final String TEXT_37 = ".prepareStatement(updateQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_38 = NL + NL + "String insertQuery = \"INSERT INTO ";
  protected final String TEXT_39 = " (\"+select_query+\")\";" + NL + "pstmt_";
  protected final String TEXT_40 = " = conn_";
  protected final String TEXT_41 = ".prepareStatement(insertQuery);" + NL + "" + NL + "String updateQuery = \"UPDATE ";
  protected final String TEXT_42 = " SET (";
  protected final String TEXT_43 = ") = (\"+select_query+\") \"";
  protected final String TEXT_44 = NL + "+\"  WHERE \" + CodeGenerationUtils.replaceAllCrBySpace(";
  protected final String TEXT_45 = ")";
  protected final String TEXT_46 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_47 = " = conn_";
  protected final String TEXT_48 = ".prepareStatement(updateQuery);" + NL + "\t\t" + NL + "\t";
  protected final String TEXT_49 = NL + NL + "String updateQuery = \"UPDATE ";
  protected final String TEXT_50 = " SET (";
  protected final String TEXT_51 = ") = (\"+select_query+\") \"";
  protected final String TEXT_52 = NL + "+\"  WHERE \" + CodeGenerationUtils.replaceAllCrBySpace(";
  protected final String TEXT_53 = ")";
  protected final String TEXT_54 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_55 = " = conn_";
  protected final String TEXT_56 = ".prepareStatement(updateQuery);" + NL + "\t\t\t\t" + NL + "String insertQuery = \"INSERT INTO ";
  protected final String TEXT_57 = " (\"+select_query+\")\";" + NL + "pstmt_";
  protected final String TEXT_58 = " = conn_";
  protected final String TEXT_59 = ".prepareStatement(insertQuery);" + NL + "" + NL + "\t";
  protected final String TEXT_60 = NL + "\t" + NL + "String deleteQuery = \"DELETE  FROM (\"+select_query+\") ";
  protected final String TEXT_61 = "\"";
  protected final String TEXT_62 = NL + "+\"  WHERE \" + CodeGenerationUtils.replaceAllCrBySpace(";
  protected final String TEXT_63 = ")";
  protected final String TEXT_64 = NL + ";" + NL + "pstmt_";
  protected final String TEXT_65 = " = conn_";
  protected final String TEXT_66 = ".prepareStatement(deleteQuery);" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_72 = NL + NL + "System.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "nb_line_inserted_";
  ...
  protected final String TEXT_80 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Inserting with : \\n\" + insertQuery + \"\\n\");" + NL + "\t\tnb_line_inserted_";
  protected final String TEXT_81 = " = pstmtInsert_";
  ...
  protected final String TEXT_87 = NL + "\ttry{" + NL + "\t\tSystem.out.println(\"Updating with : \\n\" + updateQuery +\"\\n\");" + NL + "\t\tnb_line_update_";
  protected final String TEXT_88 = " = pstmtUpdate_";
  ...
  protected final String TEXT_91 = " = pstmtInsert_";
  protected final String TEXT_92 = ".executeUpdate();" + NL + "\t\tSystem.out.println(\"--> \" + nb_line_inserted_";
  protected final String TEXT_93 = " + \" rows inserted. \\n\");" + NL + "\t}";
  protected final String TEXT_94 = NL + "\tSystem.out.println(\"Deleting with : \\n\" + deleteQuery +\"\\n\");" + NL + "\t\tnb_line_deleted_";
  protected final String TEXT_95 = " = pstmt_";
  protected final String TEXT_96 = ".executeUpdate();" + NL + "\tSystem.out.println(\"--> \" + nb_line_deleted_";
  protected final String TEXT_97 = " + \" rows deleted. \\n\");" + NL + "\t\t";
  protected final String TEXT_98 = NL + NL + "if(pstmtUpdate_";
  protected final String TEXT_99 = " != null){" + NL + "" + NL + "\tpstmtUpdate_";
  protected final String TEXT_100 = ".close();" + NL + "\t" + NL + "}else if(pstmt_";
  protected final String TEXT_101 = " != null) {" + NL + "" + NL + "\tpstmt_";
  protected final String TEXT_102 = ".close();" + NL + "\t" + NL + "}" + NL + "" + NL + "conn_";
  protected final String TEXT_103 = " .close();" + NL;
  protected final String TEXT_104 = NL + "pstmt_";
  protected final String TEXT_105 = ".close();" + NL + "conn_";
