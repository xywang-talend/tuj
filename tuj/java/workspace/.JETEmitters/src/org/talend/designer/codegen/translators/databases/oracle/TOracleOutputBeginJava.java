...
public class TOracleOutputBeginJava
{
  ...
  protected final String TEXT_16 = " = false;" + NL + "" + NL + "java.sql.Connection conn_";
  ...
  protected final String TEXT_21 = NL + "\tjava.lang.Class.forName(\"oracle.jdbc.driver.OracleDriver\");" + NL + "\t" + NL + "\t";
  ...
  protected final String TEXT_38 = ";" + NL + "" + NL + "\tconn_";
