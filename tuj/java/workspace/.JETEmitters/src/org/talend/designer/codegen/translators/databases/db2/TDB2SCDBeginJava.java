...
public class TDB2SCDBeginJava
{
  ...
  protected final String TEXT_2 = NL + "\t// Create database connection" + NL + "\tjava.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "\tString connectionString_";
  ...
  protected final String TEXT_48 = NL + "\t\t\t+ \" WHERE YEAR(";
  ...
  protected final String TEXT_170 = NL + "\t\t\t\" AND YEAR(";
  ...
  protected final String TEXT_187 = NL + "\t\t\t\t+ \" AND YEAR(";
...
if (inMetadata != null && metadata != null) {
		...
		for (IMetadataColumn column : metadata.getListColumns()) {
	        ...
	        if (colname.equals(surrogateKeyField)) {
	            ...
	            if (surrogateKeyCreation.equals("DB_SEQUENCE")) {
	            	parameters.add("nextval for " + skSequence);
	            } else {
		            parameters.add("?");
	            }
	            colposition++;
    ...
    stringBuffer.append(surrogateKeyCreation.equals("DB_SEQUENCE") ? "nextval for \" + " + skSequence + " + \", " : "");
