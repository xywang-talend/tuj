...
public class TJDBCOutputMainJava
{
  ...
  protected final String TEXT_131 = " = statement_";
  ...
  protected final String TEXT_140 = " + statementUpdate_";
  ...
  protected final String TEXT_155 = " + statementInsert_";
  ...
  protected final String TEXT_171 = NL + "    " + NL + "        try" + NL + "        {" + NL + "            updateFlag_";
  ...
  protected final String TEXT_191 = " + statementInsert_";
  ...
  protected final String TEXT_232 = ") {" + NL + "            connection_";
  protected final String TEXT_233 = ".commit();" + NL + "            commitCounter_";
  protected final String TEXT_234 = "=0;" + NL + "        }" + NL;
...
class Operation{
    ...
    public void generateSetStmt(String typeToGenerate,Column column,
        ...
        if(stmtType == Operation.NORMAL_TYPE){
            ...
            prefix = "statementInsert_";
        }else if(stmtType == Operation.UPDATE_TYPE){
            prefix = "statementUpdate_";
        }
