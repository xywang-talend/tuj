...
public class TSybaseRowBeginJava
{
  ...
  protected final String TEXT_2 = NL + "java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_3 = " = \"jdbc:sybase:Tds:\"+";
  protected final String TEXT_4 = "+\":\"+";
  protected final String TEXT_5 = "+\"/\"+";
  protected final String TEXT_6 = "; " + NL + "" + NL + "String dbUser_";
  protected final String TEXT_7 = " = ";
  protected final String TEXT_8 = ";" + NL + "" + NL + "String dbPwd_";
