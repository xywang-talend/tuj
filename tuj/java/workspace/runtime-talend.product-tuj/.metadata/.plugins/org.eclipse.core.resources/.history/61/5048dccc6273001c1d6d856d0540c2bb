...
public class TSybaseSCDBeginJava
{
  ...
  protected final String TEXT_2 = NL + "\t// Create database connection" + NL + "\tjava.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "\tString connectionString_";
  protected final String TEXT_3 = " = \"jdbc:sybase:Tds:\" + ";
