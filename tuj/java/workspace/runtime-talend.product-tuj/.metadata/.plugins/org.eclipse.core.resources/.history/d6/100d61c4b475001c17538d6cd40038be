...
if ((metadatas!=null)&&(metadatas.size()>0)) {//1
    ...
    stringBuffer.append(TEXT_53);
                ...
                if(mainjavaType == JavaTypesManager.DATE || 
                        ...
                        mainjavaType == JavaTypesManager.LONG ||
                        mainjavaType == JavaTypesManager.INTEGER){
                    if(mainTypeName.equals("java.util.Date") || 
                            mainTypeName.equals("Byte") || 
                            mainTypeName.equals("Short") || 
                            mainTypeName.equals("Float") || 
                            mainTypeName.equals("Double") || 
                            mainTypeName.equals("Long") || 
                            mainTypeName.equals("Integer")) {
