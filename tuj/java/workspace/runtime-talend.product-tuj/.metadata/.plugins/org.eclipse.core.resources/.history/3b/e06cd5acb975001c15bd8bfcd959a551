...
public class TOracleOutputMainJava
{
  ...
  protected final String TEXT_159 = NL + "\t" + NL + "" + NL + "        try{" + NL + "            updateFlag_";
  ...
  protected final String TEXT_180 = ".executeUpdate();" + NL + "               " + NL + "            }catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_222 = "=0;" + NL + "        " + NL + "        }\t" + NL + "" + NL + "\t";
