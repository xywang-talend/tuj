...
public class TSCPGetBeginJava
{
  ...
  protected final String TEXT_24 = " == false)" + NL + "                      throw new java.io.IOException(\"Authentication failed.\");";
  ...
  protected final String TEXT_30 = " == false)" + NL + "            throw new java.io.IOException(\"Authentication failed.\");";
  protected final String TEXT_31 = "                 " + NL + "        ch.ethz.ssh2.SCPClient scp_";
  protected final String TEXT_32 = " = new  ch.ethz.ssh2.SCPClient(conn_";
  protected final String TEXT_33 = ");" + NL + "        " + NL + "        String[] sourceFileNames_";
