...
public class TXMLRPCInputBeginJava
{
  ...
  protected final String TEXT_22 = "      " + NL + "        };  " + NL + "        String[] results_";
  ...
  protected final String TEXT_60 = "] = String.valueOf(iter_";
  protected final String TEXT_61 = ".next());" + NL + "                }\t\t\t\t" + NL + "\t\t\t} else {" + NL + "\t\t\t\tresults_";
  protected final String TEXT_62 = "[0] = String.valueOf(tempArray_";
  protected final String TEXT_63 = "[i_";
  protected final String TEXT_64 = "]);" + NL + "\t\t\t}" + NL + "\t\t\t" + NL + "\t" + NL + "        nb_line_";
  protected final String TEXT_65 = "++;" + NL + "\t       " + NL + "// for output";
  protected final String TEXT_66 = NL + NL + "\t\t\t";
  protected final String TEXT_67 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t" + NL + "\t\t\tif(";
  protected final String TEXT_68 = " < results_";
  protected final String TEXT_69 = ".length && results_";
  protected final String TEXT_70 = "[";
  protected final String TEXT_71 = "]!=null){\t\t\t\t";
  protected final String TEXT_72 = NL + "\t\t\t\t\t";
  protected final String TEXT_73 = ".";
  protected final String TEXT_74 = " = results_";
  protected final String TEXT_75 = "[";
  protected final String TEXT_76 = "];";
  protected final String TEXT_77 = NL + "\t\t\t\t\t";
  protected final String TEXT_78 = ".";
  protected final String TEXT_79 = " = ParserUtils.parseTo_Date(results_";
  ...
  protected final String TEXT_87 = "].getBytes();" + NL + "\t";
  ...
  protected final String TEXT_94 = NL + "\t\t\t" + NL + "\t\t\t} else { " + NL + "\t\t\t" + NL + "\t\t\t\t\t";
