...
public class TInformixOutputBeginJava
{
  ...
  protected final String TEXT_10 = " = false;" + NL + "" + NL + "java.lang.Class.forName(\"com.informix.jdbc.IfxDriver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_11 = " = \"jdbc:informix-sqli://\" + ";
  protected final String TEXT_12 = " + \":\" + ";
  protected final String TEXT_13 = " + \"/\" + ";
  protected final String TEXT_14 = " + \":informixserver=\" + ";
  protected final String TEXT_15 = ";" + NL;
  protected final String TEXT_16 = NL;
  protected final String TEXT_17 = NL + "    int keyCount_";
  protected final String TEXT_18 = " = ";
  protected final String TEXT_19 = ";" + NL + "    if(keyCount_";
  protected final String TEXT_20 = " < 1)" + NL + "    {" + NL + "    \tthrow new Exception(\"For update or delete, Schema must have a key\");" + NL + "    }";
  ...
  protected final String TEXT_30 = NL + "java.sql.Statement stmtClear_";
  protected final String TEXT_31 = " = conn_";
  protected final String TEXT_32 = ".createStatement();" + NL + "deletedCount_";
  protected final String TEXT_33 = " = deletedCount_";
  protected final String TEXT_34 = " + stmtClear_";
  protected final String TEXT_35 = ".executeUpdate(\"delete from \\\"\" + ";
  protected final String TEXT_36 = "+\"\\\"\");";
  protected final String TEXT_37 = NL;
  protected final String TEXT_38 = NL + NL + "java.sql.PreparedStatement pstmtInsert_";
  protected final String TEXT_39 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmtUpdate_";
  protected final String TEXT_40 = " =null;" + NL + "" + NL + "java.sql.PreparedStatement pstmt_";
  ...
  protected final String TEXT_46 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  ...
  protected final String TEXT_52 = ".prepareStatement(\"UPDATE \\\"\"+";
  protected final String TEXT_53 = "+\"\\\" SET ";
  protected final String TEXT_54 = " WHERE ";
  protected final String TEXT_55 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_56 = NL + "\t\tpstmt_";
  protected final String TEXT_57 = " = conn_";
  protected final String TEXT_58 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_59 = " + \"\\\" WHERE ";
  protected final String TEXT_60 = "\");\t" + NL + "\t" + NL + "\t\tpstmtInsert_";
  ...
  protected final String TEXT_65 = ")\");" + NL + "" + NL + "\t\tpstmtUpdate_";
  protected final String TEXT_66 = " = conn_";
  protected final String TEXT_67 = ".prepareStatement(\"UPDATE \\\"\"+";
  protected final String TEXT_68 = "+\"\\\" SET ";
  protected final String TEXT_69 = " WHERE ";
  protected final String TEXT_70 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_71 = NL + "\t\tpstmtUpdate_";
  protected final String TEXT_72 = " = conn_";
  protected final String TEXT_73 = ".prepareStatement(\"UPDATE \\\"\"+";
  ...
  protected final String TEXT_84 = ".prepareStatement(\"DELETE  FROM \\\"\"+";
  protected final String TEXT_85 = "+\"\\\" WHERE ";
  protected final String TEXT_86 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_87 = NL + NL + "int commitEvery_";
  protected final String TEXT_88 = " = ";
  protected final String TEXT_89 = ";" + NL + "" + NL + "int commitCounter_";
  protected final String TEXT_90 = " = 0;" + NL + "" + NL + "conn_";
