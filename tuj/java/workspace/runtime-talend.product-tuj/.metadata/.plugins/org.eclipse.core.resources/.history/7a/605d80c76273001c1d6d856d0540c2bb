...
public class TTeradataOutputMainJava
{
  ...
  protected final String TEXT_130 = " = true;" + NL + "\t\t\t    ";
  protected final String TEXT_131 = NL + "\t                throw(e);" + NL + "\t                ";
  ...
  protected final String TEXT_138 = ".errorMessage = e.getMessage();" + NL + "\t                    ";
  ...
  protected final String TEXT_145 = " = true;" + NL + "\t\t\t    ";
  protected final String TEXT_146 = NL + "\t                throw(e);" + NL + "\t                ";
  ...
  protected final String TEXT_153 = ".errorMessage = e.getMessage();" + NL + "\t                    ";
  protected final String TEXT_154 = NL + "\t                    System.err.print(e.getMessage());" + NL + "\t                    ";
  ...
  protected final String TEXT_159 = NL + NL + "    try{" + NL + "        updateFlag_";
  ...
  protected final String TEXT_181 = " = true;" + NL + "\t\t    ";
