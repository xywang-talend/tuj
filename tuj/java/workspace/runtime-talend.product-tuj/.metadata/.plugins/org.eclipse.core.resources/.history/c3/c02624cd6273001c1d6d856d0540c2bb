...
public class TSybaseInputBeginJava
{
  ...
  protected final String TEXT_3 = " = 0;" + NL + "java.lang.Class.forName(\"com.sybase.jdbc3.jdbc.SybDriver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_4 = " = \"jdbc:sybase:Tds:\"+";
