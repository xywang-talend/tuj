...
public class TMSSqlOutputBeginJava
{
  ...
  protected final String TEXT_10 = " = false;" + NL + "" + NL + "java.lang.Class.forName(\"net.sourceforge.jtds.jdbc.Driver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_11 = " = \"jdbc:jtds:sqlserver://\"+";
  ...
  protected final String TEXT_70 = NL + NL + "pstmtUpdate_";
