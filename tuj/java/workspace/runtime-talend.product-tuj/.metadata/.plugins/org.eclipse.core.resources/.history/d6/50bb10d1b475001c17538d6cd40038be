...
public class TNormalizeBeginJava
{
  ...
  protected final String TEXT_5 = " = null;" + NL + "    StringBuffer currentRecord_";
  protected final String TEXT_6 = " = null;" + NL + "    java.util.Set<String> recordSet_";
  protected final String TEXT_7 = " = new java.util.HashSet<String>();    ";
