...
public class TAccessOutputBeginJava
{
  ...
  protected final String TEXT_16 = " = false;" + NL + "" + NL + "java.lang.Class.forName(\"sun.jdbc.odbc.JdbcOdbcDriver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_17 = " = \"jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=\" + ";
  protected final String TEXT_18 = ";" + NL + "" + NL + "String userName_";
  protected final String TEXT_19 = " = ";
  protected final String TEXT_20 = ";" + NL + "" + NL + "String password_";
  ...
  protected final String TEXT_24 = ",userName_";
  ...
  protected final String TEXT_68 = NL + "\t\tpstmtUpdate_";
