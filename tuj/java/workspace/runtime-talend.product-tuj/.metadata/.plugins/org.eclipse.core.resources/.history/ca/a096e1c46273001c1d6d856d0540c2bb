...
public class TJavaDBRowBeginJava
{
  ...
  protected final String TEXT_47 = " = 0;" + NL + "" + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_48 = " = null;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_49 = " = false;" + NL + "" + NL + "globalMap.put(\"";
