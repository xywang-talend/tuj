...
public class TMSSqlInputBeginJava
{
  ...
  protected final String TEXT_3 = " = 0;" + NL + "" + NL + "java.lang.Class.forName(\"net.sourceforge.jtds.jdbc.Driver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_4 = " = \"jdbc:jtds:sqlserver://\"+";
  ...
  protected final String TEXT_17 = ".createStatement();" + NL + "java.sql.ResultSet rs_";
  protected final String TEXT_18 = " = stmt_";
  protected final String TEXT_19 = ".executeQuery(";
  protected final String TEXT_20 = ");" + NL + "java.sql.ResultSetMetaData rsmd_";
  protected final String TEXT_21 = " = rs_";
  protected final String TEXT_22 = ".getMetaData();" + NL + "int colQtyInRs_";
  ...
  protected final String TEXT_67 = " =  null;" + NL + "\t\t\t }" + NL + "\t\t\t " + NL + "\t\t\t ";
