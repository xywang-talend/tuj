...
public class TTeradataFastLoadEndJava
{
  ...
  protected final String TEXT_18 = ".executeBatch();" + NL + "pstmt_";
  protected final String TEXT_19 = ".clearBatch();" + NL + "pstmt_";
  protected final String TEXT_20 = ".close();" + NL + "conn_";
  protected final String TEXT_21 = ".commit();" + NL + "conn_";
