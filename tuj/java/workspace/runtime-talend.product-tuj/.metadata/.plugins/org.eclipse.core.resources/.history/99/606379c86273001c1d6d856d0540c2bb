...
public class TInterbaseOutputBeginJava
{
  ...
  protected final String TEXT_12 = " = \"jdbc:interbase://\" + ";
  protected final String TEXT_13 = " + \"/\" + ";
  protected final String TEXT_14 = ";" + NL + "" + NL + "String userName_";
  protected final String TEXT_15 = " = ";
  protected final String TEXT_16 = ";" + NL + "" + NL + "String password_";
  ...
  protected final String TEXT_59 = "\");" + NL + "" + NL + "pstmtUpdate_";
  protected final String TEXT_60 = " = conn_";
  protected final String TEXT_61 = ".prepareStatement(\"UPDATE \\\"\" + ";
  protected final String TEXT_62 = " + \"\\\" SET ";
  protected final String TEXT_63 = " WHERE ";
  protected final String TEXT_64 = "\");\t" + NL + "\t" + NL + "pstmtInsert_";
  protected final String TEXT_65 = " = conn_";
  protected final String TEXT_66 = ".prepareStatement(\"INSERT INTO \\\"\" + ";
