...
public class THSQLDbRowEndJava
{
  ...
  protected final String TEXT_8 = ".close();" + NL + "" + NL + "java.sql.Statement stmtClose_";
  protected final String TEXT_9 = " = conn_";
  protected final String TEXT_10 = ".createStatement();" + NL + "stmtClose_";
  protected final String TEXT_11 = ".execute(\"SHUTDOWN\");" + NL + "conn_";
