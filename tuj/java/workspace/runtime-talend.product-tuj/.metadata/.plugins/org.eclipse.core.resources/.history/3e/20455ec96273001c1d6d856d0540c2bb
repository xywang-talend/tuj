...
public class TMysqlRowBeginJava
{
  ...
  protected final String TEXT_21 = NL + NL + "java.sql.PreparedStatement pstmt_";
  protected final String TEXT_22 = " = null;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_23 = " = false;" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_24 = "_QUERY\",";
  protected final String TEXT_25 = ");";
  protected final String TEXT_26 = NL + NL + "int commitEvery_";
  protected final String TEXT_27 = " = ";
  protected final String TEXT_28 = ";" + NL + "" + NL + "int commitCounter_";
  protected final String TEXT_29 = " = 0;" + NL + "" + NL + "if(conn_";
  protected final String TEXT_30 = ".getAutoCommit())" + NL + "{" + NL + "\tconn_";
  protected final String TEXT_31 = ".setAutoCommit(false);" + NL + "}";
