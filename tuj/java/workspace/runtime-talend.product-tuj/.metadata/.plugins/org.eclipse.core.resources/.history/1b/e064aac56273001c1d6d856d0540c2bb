...
public class TMysqlSCDMainJava
{
  ...
  protected final String TEXT_62 = " != null) {" + NL + "\t\t\t\t\t\t// timestamp < min java date value (year 1) || timestamp > max mysql value (year 10000) => set 0000-00-00 as date in MySQL" + NL + "\t\t\t\t\t\tdate_";
  protected final String TEXT_63 = " = ";
  protected final String TEXT_64 = ".getTime();" + NL + "\t\t\t\t\t\tif (date_";
  protected final String TEXT_65 = " < year1_";
  protected final String TEXT_66 = " || date_";
  protected final String TEXT_67 = " >= year10000_";
  protected final String TEXT_68 = ") {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_69 = ".setString(";
  protected final String TEXT_70 = ", \"0000-00-00 00:00:00\");" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_71 = ".setTimestamp(";
  protected final String TEXT_72 = ", new java.sql.Timestamp(date_";
  protected final String TEXT_73 = "));" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t} else {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_74 = ".setNull(";
  protected final String TEXT_75 = ", java.sql.Types.DATE);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_82 = NL + "    // Lookup source keys";
  protected final String TEXT_83 = NL + "\t    \t\tlookupRow_";
  protected final String TEXT_84 = ".";
  protected final String TEXT_85 = " = ";
  protected final String TEXT_86 = ".";
  protected final String TEXT_87 = ";" + NL + "\t    \t\t";
  protected final String TEXT_88 = NL + "    lookupRow_";
  protected final String TEXT_89 = ".hashCodeDirty = true; // Regenerate hash code" + NL + "   \tcacheRow_";
  protected final String TEXT_90 = " = cache_";
  protected final String TEXT_91 = ".get(lookupRow_";
  protected final String TEXT_92 = ");" + NL + "    " + NL + "\tif (cacheRow_";
  protected final String TEXT_93 = " == null) {" + NL + "\t\t// Insert new source id" + NL + "\t\t";
  protected final String TEXT_94 = NL + "\t\tinsertQuery_";
  protected final String TEXT_95 = ".executeUpdate();" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_96 = NL + "\t\t\tSystem.out.println(\"[";
  protected final String TEXT_97 = "] new source id inserted\");" + NL + "\t\t\t";
  protected final String TEXT_98 = NL + "\t} else {" + NL + "\t\t";
  protected final String TEXT_99 = NL + "\t\t\t// L1 fields" + NL + "\t\t\tif (";
  protected final String TEXT_100 = " || ";
  protected final String TEXT_101 = "((cacheRow_";
  protected final String TEXT_102 = ".";
  protected final String TEXT_103 = " == null && ";
  protected final String TEXT_104 = ".";
  protected final String TEXT_105 = " != null) ||" + NL + "\t\t\t\t\t\t\t\t   (cacheRow_";
  protected final String TEXT_106 = ".";
  protected final String TEXT_107 = " != null && !cacheRow_";
  protected final String TEXT_108 = ".";
  protected final String TEXT_109 = ".equals(";
  protected final String TEXT_110 = ".";
  protected final String TEXT_111 = ")))";
  protected final String TEXT_112 = "cacheRow_";
  protected final String TEXT_113 = ".";
  protected final String TEXT_114 = " != ";
  protected final String TEXT_115 = ".";
  protected final String TEXT_116 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_117 = NL + "\t\t\t\tl1Query_";
  protected final String TEXT_118 = ".executeUpdate();" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_119 = NL + "\t\t\t\t\tSystem.out.println(\"[";
  protected final String TEXT_120 = "] l1 update done\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_121 = NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_122 = NL + "\t\t\t// L2 fields" + NL + "\t\t\tif (";
  protected final String TEXT_123 = " || ";
  protected final String TEXT_124 = "((cacheRow_";
  protected final String TEXT_125 = ".";
  protected final String TEXT_126 = " == null && ";
  protected final String TEXT_127 = ".";
  protected final String TEXT_128 = " != null) ||" + NL + "\t\t\t\t\t\t\t\t   (cacheRow_";
  protected final String TEXT_129 = ".";
  protected final String TEXT_130 = " != null && !cacheRow_";
  protected final String TEXT_131 = ".";
  protected final String TEXT_132 = ".equals(";
  protected final String TEXT_133 = ".";
  protected final String TEXT_134 = ")))";
  protected final String TEXT_135 = "cacheRow_";
  protected final String TEXT_136 = ".";
  protected final String TEXT_137 = " != ";
  protected final String TEXT_138 = ".";
  protected final String TEXT_139 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_140 = NL + "    \t\t\tl2Query_";
  protected final String TEXT_141 = ".executeUpdate();" + NL + "    \t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\tinsertQuery_";
  protected final String TEXT_143 = ".executeUpdate();" + NL + "\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\t\tSystem.out.println(\"[";
  protected final String TEXT_145 = "] new history line\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t}" + NL + "\t\t";
  protected final String TEXT_147 = NL + "\t\t\t// L3 fields" + NL + "\t\t\tboolean l3Change_";
  protected final String TEXT_148 = " = false;" + NL + "\t\t\t";
  protected final String TEXT_149 = NL + "\t\t\t\t\t\tif ((cacheRow_";
  protected final String TEXT_150 = ".";
  protected final String TEXT_151 = " == null && ";
  protected final String TEXT_152 = ".";
  protected final String TEXT_153 = " != null) ||" + NL + "\t\t\t\t\t\t   (cacheRow_";
  protected final String TEXT_154 = ".";
  protected final String TEXT_155 = " != null && !cacheRow_";
  protected final String TEXT_156 = ".";
  protected final String TEXT_157 = ".equals(";
  protected final String TEXT_158 = ".";
  protected final String TEXT_159 = "))) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_160 = NL + "\t                \tif (cacheRow_";
  protected final String TEXT_161 = ".";
  protected final String TEXT_162 = " != ";
  protected final String TEXT_163 = ".";
  protected final String TEXT_164 = ") {" + NL + "\t                \t";
  protected final String TEXT_165 = NL + "\t                \tl3Change_";
  protected final String TEXT_166 = " = true;" + NL + "\t                }" + NL + "\t                ";
  protected final String TEXT_167 = NL + "\t\t\tif (l3Change_";
  protected final String TEXT_168 = ") {" + NL + "\t\t\t\t";
  protected final String TEXT_169 = NL + "\t\t\t\t\t\t\tif (!((cacheRow_";
  protected final String TEXT_170 = ".";
  protected final String TEXT_171 = " == null && ";
  protected final String TEXT_172 = ".";
  protected final String TEXT_173 = " != null) ||" + NL + "\t\t\t\t\t\t\t   (cacheRow_";
  protected final String TEXT_174 = ".";
  protected final String TEXT_175 = " != null && !cacheRow_";
  protected final String TEXT_176 = ".";
  protected final String TEXT_177 = ".equals(";
  protected final String TEXT_178 = ".";
  protected final String TEXT_179 = ")))) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_180 = NL + "\t\t                \tif (cacheRow_";
  protected final String TEXT_181 = ".";
  protected final String TEXT_182 = " == ";
  protected final String TEXT_183 = ".";
  protected final String TEXT_184 = ") {" + NL + "\t\t                \t";
  protected final String TEXT_185 = NL + "\t\t                }" + NL + "\t\t                ";
  protected final String TEXT_186 = NL + "\t\t\t\t" + NL + "\t\t\t\tl3Query_";
  protected final String TEXT_187 = ".executeUpdate();" + NL + "\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_188 = NL + "\t\t\t\t\tSystem.out.println(\"[";
  protected final String TEXT_189 = "] l3 update done\");" + NL + "\t\t\t\t\t";
