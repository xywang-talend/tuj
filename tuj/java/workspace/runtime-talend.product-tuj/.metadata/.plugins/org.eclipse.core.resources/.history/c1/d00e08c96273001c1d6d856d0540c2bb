...
public class TFlowMeterCatcherBeginJava
{
  ...
  protected final String TEXT_21 = ".reference = MetterCatcherUtils.getConnLinesCount(mcm.getReferense()+\"_count\");" + NL + "\t\t";
  protected final String TEXT_22 = ".thresholds = mcm.getThresholds();" + NL + "\t\t";
