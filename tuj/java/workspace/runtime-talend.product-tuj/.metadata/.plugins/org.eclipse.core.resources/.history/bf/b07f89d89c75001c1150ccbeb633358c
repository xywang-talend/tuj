...
public class TOracleOutputBulkBeginJava
{
  ...
  protected final String TEXT_6 = " = \"\\r\\n\";" + NL + "\t\t" + NL + "\t\tfinal java.io.BufferedWriter out";
  protected final String TEXT_7 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "        \t\tnew java.io.FileOutputStream(";
