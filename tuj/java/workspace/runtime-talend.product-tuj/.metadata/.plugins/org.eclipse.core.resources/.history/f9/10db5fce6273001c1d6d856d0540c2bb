...
public class TIngresOutputBeginJava
{
  ...
  protected final String TEXT_10 = " = false;" + NL + "" + NL + "java.lang.Class.forName(\"com.ingres.jdbc.IngresDriver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_11 = " = \"jdbc:ingres://\"+";
  ...
  protected final String TEXT_75 = "\");" + NL + "" + NL + "" + NL + "\t\tpstmtInsert_";
  ...
  protected final String TEXT_90 = ".setAutoCommit(false);" + NL + "\t";
