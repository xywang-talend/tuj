...
public class TDB2InputBeginJava
{
  ...
  protected final String TEXT_3 = " = 0;" + NL + "" + NL + "java.lang.Class.forName(\"com.ibm.db2.jcc.DB2Driver\");" + NL + "" + NL + "String url_";
  protected final String TEXT_4 = " = \"jdbc:db2://\"+";
  ...
  protected final String TEXT_73 = NL + NL + " \t   \t\t \tif(rs_";
