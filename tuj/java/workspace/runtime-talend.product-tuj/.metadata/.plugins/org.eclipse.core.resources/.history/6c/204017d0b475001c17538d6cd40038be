...
public class THSQLDbOutputBeginJava
{
  ...
  protected final String TEXT_32 = " = 0;" + NL + "" + NL + "int deletedCount_";
  protected final String TEXT_33 = "=0;" + NL + "int updatedCount_";
  protected final String TEXT_34 = "=0;" + NL + "int insertedCount_";
  protected final String TEXT_35 = "=0;" + NL + "" + NL + "boolean whetherReject_";
  protected final String TEXT_36 = " = false;" + NL + "" + NL + "java.lang.Class.forName(\"org.hsqldb.jdbcDriver\");" + NL;
  protected final String TEXT_37 = NL;
  protected final String TEXT_38 = NL + "    int keyCount_";
  protected final String TEXT_39 = " = ";
  protected final String TEXT_40 = ";" + NL + "    if(keyCount_";
  protected final String TEXT_41 = " < 1)" + NL + "    {" + NL + "    \tthrow new Exception(\"For update or delete, Schema must have a key\");" + NL + "    }";
  ...
  protected final String TEXT_56 = ".executeUpdate(\"delete from \\\"\" + ";
  ...
  protected final String TEXT_67 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  ...
  protected final String TEXT_83 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  ...
  protected final String TEXT_88 = ".prepareStatement(\"UPDATE \\\"\"+";
  protected final String TEXT_89 = "+\"\\\" SET ";
  protected final String TEXT_90 = " WHERE ";
  protected final String TEXT_91 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_92 = NL + "\t\tpstmtUpdate_";
  protected final String TEXT_93 = " = conn_";
  protected final String TEXT_94 = ".prepareStatement(\"UPDATE \\\"\"+";
  ...
  protected final String TEXT_99 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  ...
  protected final String TEXT_105 = ".prepareStatement(\"DELETE  FROM \\\"\"+";
  ...
  protected final String TEXT_112 = ".setAutoCommit(false);";
