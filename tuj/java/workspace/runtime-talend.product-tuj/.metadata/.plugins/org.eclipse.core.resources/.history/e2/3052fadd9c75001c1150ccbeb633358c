...
public class TSQLiteOutputBeginJava
{
  ...
  protected final String TEXT_12 = " = \"jdbc:sqlite:\"+ \"/\" + ";
  protected final String TEXT_13 = ".toLowerCase();" + NL;
  protected final String TEXT_14 = NL;
  protected final String TEXT_15 = NL + "    int keyCount_";
  protected final String TEXT_16 = " = ";
  protected final String TEXT_17 = ";" + NL + "    if(keyCount_";
  protected final String TEXT_18 = " < 1)" + NL + "    {" + NL + "    \tthrow new Exception(\"For update or delete, Schema must have a key\");" + NL + "    }";
  ...
  protected final String TEXT_22 = NL + "java.sql.Statement stmtClear_";
  ...
  protected final String TEXT_26 = " + stmtClear_";
  ...
  protected final String TEXT_36 = "\t" + NL + "\t" + NL + "pstmt_";
  protected final String TEXT_37 = " = conn_";
  protected final String TEXT_38 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  ...
  protected final String TEXT_44 = ".prepareStatement(\"UPDATE \\\"\"+";
  protected final String TEXT_45 = "+\"\\\" SET ";
  protected final String TEXT_46 = " WHERE ";
  protected final String TEXT_47 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_48 = NL + "pstmt_";
  protected final String TEXT_49 = " = conn_";
  protected final String TEXT_50 = ".prepareStatement(\"SELECT COUNT(1) FROM \\\"\" + ";
  protected final String TEXT_51 = " + \"\\\" WHERE ";
  protected final String TEXT_52 = "\");\t" + NL + "\t" + NL + "pstmtInsert_";
  protected final String TEXT_53 = " = conn_";
  protected final String TEXT_54 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  protected final String TEXT_55 = "+\"\\\" (";
  protected final String TEXT_56 = ") VALUES (";
  protected final String TEXT_57 = ")\");" + NL + "" + NL + "pstmtUpdate_";
  protected final String TEXT_58 = " = conn_";
  protected final String TEXT_59 = ".prepareStatement(\"UPDATE \\\"\"+";
  protected final String TEXT_60 = "+\"\\\" SET ";
  protected final String TEXT_61 = " WHERE ";
  protected final String TEXT_62 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_63 = NL + "pstmtUpdate_";
  ...
  protected final String TEXT_70 = ".prepareStatement(\"INSERT INTO \\\"\"+";
  ...
  protected final String TEXT_76 = ".prepareStatement(\"DELETE  FROM \\\"\"+";
  protected final String TEXT_77 = "+\"\\\" WHERE ";
  protected final String TEXT_78 = "\");" + NL + "" + NL + "\t";
  protected final String TEXT_79 = NL + NL + "int commitEvery_";
  protected final String TEXT_80 = " = ";
  protected final String TEXT_81 = ";" + NL + "" + NL + "int commitCounter_";
  protected final String TEXT_82 = " = 0;" + NL + "" + NL + "conn_";
  protected final String TEXT_83 = ".setAutoCommit(false);";
