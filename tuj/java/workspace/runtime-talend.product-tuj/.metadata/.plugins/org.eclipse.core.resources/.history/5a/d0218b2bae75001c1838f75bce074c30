...
public class TDB2OutputMainJava
{
  ...
  protected final String TEXT_105 = "++;" + NL + "        }catch(Exception e){" + NL + "            whetherReject_";
  ...
  protected final String TEXT_129 = ".executeUpdate(); " + NL + "            }" + NL + "            catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_144 = ".executeUpdate();" + NL + "            }" + NL + "            catch(Exception e)" + NL + "            {" + NL + "                whetherReject_";
  ...
  protected final String TEXT_191 = NL + "            }" + NL + "        } " + NL + "" + NL + "        nb_line_";
  ...
  protected final String TEXT_222 = "=0;" + NL + "        " + NL + "        }\t" + NL + "\t" + NL + "" + NL + "\t";
