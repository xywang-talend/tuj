...
// / JobDesigner (CodeGenerator version 2.2.0.GA_r6191).
...
public class Bug2189_tFileOutputPositional {
				...
				try {
					...
					if (!(e instanceof TDieException)) {
						tAssertCatcher_1.addMessage(pid, projectName, jobName,
								"java", null, "Failed", "Job execution error",
								e.getMessage());
	...
	public void tAssertCatcher_1_error() throws TalendException {
		end_Hash.put("tAssertCatcher_1", java.util.Calendar.getInstance()
				.getTimeInMillis());
	}
	...
	public void tFileCompare_1_error() throws TalendException {
		end_Hash.put("tFileCompare_1", java.util.Calendar.getInstance()
				.getTimeInMillis());
	}

	public void tAssert_1_error() throws TalendException {
		end_Hash.put("tAssert_1", java.util.Calendar.getInstance()
				.getTimeInMillis());
	}

	public void tFileInputCSV_1_error() throws TalendException {
		end_Hash.put("tFileInputCSV_1", java.util.Calendar.getInstance()
				.getTimeInMillis());
	}

	public void tContextLoad_1_error() throws TalendException {
		end_Hash.put("tContextLoad_1", java.util.Calendar.getInstance()
				.getTimeInMillis());
	}

	public void tFileInputDelimited_1_error() throws TalendException {
		end_Hash.put("tFileInputDelimited_1", java.util.Calendar.getInstance()
				.getTimeInMillis());
	}

	public void tFileOutputPositional_1_error() throws TalendException {
		end_Hash.put("tFileOutputPositional_1", java.util.Calendar
	...
	public void tAssertCatcher_1Process() throws TalendException {
		try {
			...
			String url_tMysqlOutput_1 = "jdbc:mysql://"
					+ (String) ((String) context.getProperty("result_host"))
					+ ":"
					+ (String) ((String) context.getProperty("result_port"))
					+ "/"
					+ (String) ((String) context.getProperty("result_database"));
			String dbUser_tMysqlOutput_1 = (String) ((String) context
					.getProperty("result_username"));
			String dbPwd_tMysqlOutput_1 = (String) ((String) context
			...
			start_Hash.put("tAssertCatcher_1", java.util.Calendar.getInstance()
					.getTimeInMillis());
			...
			for (AssertCatcherUtils.AssertCatcherMessage acm : tAssertCatcher_1
				...
				row2.origin = (acm.getOrigin() == null
				...
				if (row2.moment != null) {
					...
					// max mysql value (year 10000) => set 0000-00-00 as date in
					// MySQL
	...
	public void tFileCompare_1Process() throws TalendException {
		try {
			...
			start_Hash.put("tAssert_1", java.util.Calendar.getInstance()
					.getTimeInMillis());
			...
			start_Hash.put("tFileCompare_1", java.util.Calendar.getInstance()
					.getTimeInMillis());
			...
			java.nio.channels.FileChannel fileChannel_tFileCompare_1 = new java.io.FileInputStream(
					(String) ((String) context.getProperty("data_dir"))
							+ "components/tFileOutputPositional/Bug2189_tFileOutputPositional/ref1.csv")
					.getChannel();
			long fileLength_tFileCompare_1 = fileChannel_tFileCompare_1.size();
			fileChannel_tFileCompare_1.close();
			java.nio.channels.FileChannel fileChannelRef_tFileCompare_1 = new java.io.FileInputStream(
					(String) ((String) context.getProperty("data_output_dir"))
							+ pid + "/out1.csv").getChannel();
			long fileRefLength_tFileCompare_1 = fileChannelRef_tFileCompare_1
					.size();
			...
			if (fileLength_tFileCompare_1 != fileRefLength_tFileCompare_1) {
				...
				java.io.BufferedReader fileRef_tFileCompare_1 = new java.io.BufferedReader(
						new java.io.FileReader((String) ((String) context
			...
			row5.file = (String) ((String) context.getProperty("data_dir"))
					+ "components/tFileOutputPositional/Bug2189_tFileOutputPositional/ref1.csv";
			row5.file_ref = (String) ((String) context
					.getProperty("data_output_dir"))
					+ pid + "/out1.csv";
			...
			if (row5.differ == 0) {
				tAssertCatcher_1
						.addMessage(pid, projectName, jobName, "java",
								"tAssert_1", "Ok", "--",
								"tIntervalMatch-doesn't lookup one row in the lookup table");
				tAssertCatcher_1Process();
			} else {
				tAssertCatcher_1
						.addMessage(pid, projectName, jobName, "java",
	...
	public void tFileInputCSV_1Process() throws TalendException {
		try {
			...
			start_Hash.put("tContextLoad_1", java.util.Calendar.getInstance()
					.getTimeInMillis());
			...
			start_Hash.put("tFileInputCSV_1", java.util.Calendar.getInstance()
					.getTimeInMillis());
			...
			com.csvreader.CsvReader csvReadertFileInputCSV_1 = new com.csvreader.CsvReader(
					new java.io.BufferedReader(new java.io.InputStreamReader(
							new java.io.FileInputStream(/**
														 * Start field
														 * tFileInputCSV_1:FILENAME
														 */
							(String) ((String) context
			...
			if (footer_tFileInputCSV_1 > 0) {
				...
				while (csvReadertFileInputCSV_1.readRecord()) {
					...
					if (!(rowtFileInputCSV_1.length == 1 && rowtFileInputCSV_1[0]
				...
				int lastLineTemptFileInputCSV_1 = totalLinetFileInputCSV_1
						- footer_tFileInputCSV_1 < 0 ? 0
						: totalLinetFileInputCSV_1 - footer_tFileInputCSV_1;
				if (lastLinetFileInputCSV_1 > 0) {
					lastLinetFileInputCSV_1 = lastLinetFileInputCSV_1 < lastLineTemptFileInputCSV_1 ? lastLinetFileInputCSV_1
							: lastLineTemptFileInputCSV_1;
				} else {
				...
				csvReadertFileInputCSV_1 = new com.csvreader.CsvReader(
			...
			while (csvReadertFileInputCSV_1.readRecord()) {
				...
				if (rowtFileInputCSV_1.length == 1
						&& rowtFileInputCSV_1[0].equals("\015")) {// empty
																	// line when
																	// row
																	// separator
																	// is '\n'
				...
				if (lastLinetFileInputCSV_1 > -1
						&& currentLinetFileInputCSV_1 > lastLinetFileInputCSV_1) {
					break;
				}
				outputLinetFileInputCSV_1++;
				if (limittFileInputCSV_1 != -1
						&& outputLinetFileInputCSV_1 > limittFileInputCSV_1) {
					break;
				}
				...
				if (context.getProperty(key_tContextLoad_1) != null) {
					...
					System.err
							.println("tContextLoad_1, invalid parameter name : "
									+ key_tContextLoad_1);
				}
	...
	public void tFileInputDelimited_1Process() throws TalendException {
		try {
			...
			start_Hash.put("tFileOutputPositional_1", java.util.Calendar
					.getInstance().getTimeInMillis());
			currentComponent = "tFileOutputPositional_1";

			// create directory only if not exists
			String fileNewName_tFileOutputPositional_1 = (String) ((String) context
					.getProperty("data_output_dir"))
					+ pid + "/out1.csv";
			...
			if (!createFiletFileOutputPositional_1.exists()) {
				(new java.io.File(fileNewName_tFileOutputPositional_1
						.substring(0, fileNewName_tFileOutputPositional_1
								.lastIndexOf("/")))).mkdirs();
			}
			...
			start_Hash.put("tFileInputDelimited_1", java.util.Calendar
					.getInstance().getTimeInMillis());
			currentComponent = "tFileInputDelimited_1";

			org.talend.fileprocess.FileInputDelimited fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(
					(String) ((String) context.getProperty("data_dir"))
							+ "components/tFileOutputPositional/Bug2189_tFileOutputPositional/in1.csv",
					"US-ASCII", ";", "\n", false, 0, 0, -1, -1);
			while (fid_tFileInputDelimited_1.nextRecord()) {
				...
				tempStringMtFileOutputPositional_1 = (row1.id == null) ? ""
				...
				// get and format output String begin
				tempStringMtFileOutputPositional_1 = (row1.Firstname == null) ? ""
						: row1.Firstname;
				tempLengthMtFileOutputPositional_1 = tempStringMtFileOutputPositional_1
						.length();
				...
				sb_tFileOutputPositional_1.append("\n");
				outtFileOutputPositional_1.write(sb_tFileOutputPositional_1
						.toString());
			...
			end_Hash.put("tFileInputDelimited_1", java.util.Calendar
					.getInstance().getTimeInMillis());
	...
	public static int runJob(String[] args) {
		...
		try {
			java.io.InputStream inContext = Bug2189_tFileOutputPositional.class
					.getClassLoader()
					.getResourceAsStream(
							"tuj_java/bug2189_tfileoutputpositional/contexts/Default.properties");
			if (inContext != null) {
			...
			if (contextStr.compareTo("Default") != 0) {
				inContext = Bug2189_tFileOutputPositional.class
						.getClassLoader().getResourceAsStream(
								"tuj_java/bug2189_tfileoutputpositional/contexts/"
...
/*******************************************************************************
 * 31587 characters generated by Talend OpenStudio on the October 12, 2007
 * 10:14:55 AM CEST
 ******************************************************************************/
